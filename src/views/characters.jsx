                        ...
                        return (
                            <Card key={index} style={{ width: '18rem', color: 'white', background: 'black' }}>
                                ...
                                <Card.Footer>
                                    ...
                                    <Card.Text><p style={{ fontStyle: 'italic', color: 'lime' }}>“It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first victory against the evil Galactic Empire. During the battle, Rebel spies managed to steal secret plans to the Empire's ultimate weapon, the DEATH STAR, and space station with enough power to destroy an entire planet.
